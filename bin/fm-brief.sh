...
#   tracked-code work loads the mandatory second-mate review-loop owner; captain-relevant
...
$PROJECT_CLONES_NOTE
Before coordinating any task that will change tracked code, load \`nathan-coding-loop\` and follow it as the single owner of the mandatory developer-reviewer procedure.
