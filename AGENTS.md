...
Personal Firstmate work targets `NathanAW24/firstmate:nathan-main` and never a PR in `kunchenguid/firstmate`; `nathan-coding-loop` owns the target preflight and verification procedure.
